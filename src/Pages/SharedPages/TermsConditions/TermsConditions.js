...
const TermsConditions = () => {
  return (
    <div>
      ...
      <p>
        Welcome to <strong>The Times</strong>!
      </p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of <strong>The Times</strong>'s Website, located at
        the-times-react.web.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use <strong>The Times</strong> if you do
      ...
      <p>
        We employ the use of cookies. By accessing <strong>The Times</strong>,
        you agreed to use cookies in agreement with the{" "}
        <strong>The Times</strong>'s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, <strong>The Times</strong> and/or its licensors
        own the intellectual property rights for all material on{" "}
        <strong>The Times</strong>. All intellectual property rights are
        reserved. You may access this from The Times for your own personal use
      ...
      <ul>
        <li>
          Republish material from <strong>The Times</strong>
        </li>
        <li>
          Sell, rent or sub-license material from <strong>The Times</strong>
        </li>
        <li>
          Reproduce, duplicate or copy material from <strong>The Times</strong>
        </li>
        <li>
          Redistribute content from <strong>The Times</strong>
        </li>
      </ul>
      ...
      <p>
        ...
        Times does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of <strong>The Times</strong>,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws,{" "}
        <strong>The Times</strong> shall not be liable for the Comments or for
      ...
      <p>
        <strong>The Times</strong> reserves the right to monitor all Comments
      ...
      <p>
        You hereby grant <strong>The Times</strong> a non-exclusive license to
      ...
      <p>
        ...
        the hyperlink compensates the absence of <strong>The Times</strong>; and
      ...
      <p>
        ...
        e-mail to <strong>The Times</strong>. Please include your name, your
      ...
      <p>
        No use of <strong>The Times</strong>'s logo or other artwork will be
        allowed for linking absent a trademark license agreement.
      </p>

      <div className="d-flex justify-content-center my-3">
        <Link to="/signup">
          <button className="btn btn-success">Return to Signup</button>
        </Link>
      </div>
    </div>
  );
